...
//   // Clear user info and JWT when navigating to /auth
//   useEffect(() => {
//     const clearAuth = async () => {
//       await apiClient.post('/logout', {}, { withCredentials: true }); // Ensure you have a `/logout` endpoint to clear the JWT cookie
//       setUserInfo(undefined);
//     };
//     clearAuth();
//   }, [setUserInfo]);
